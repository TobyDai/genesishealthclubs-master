...
function ghc_scripts() {
	...
	if ( is_front_page() ) {
		...
		wp_enqueue_style( 'flickity-style', get_template_directory_uri() . '/vendor/flickity/flickity.min.css', array(), '20151215' );
		wp_enqueue_script( 'flickity-script', get_template_directory_uri() . '/vendor/flickity/flickity.pkgd.min.js', array(), '20151215', true );
	}
	else if (
		is_singular() &&
		(
...
require get_template_directory() . '/inc/post-types/slide.php';
...
require get_template_directory() . '/inc/template-functions/employee.php';
require get_template_directory() . '/inc/template-functions/location.php';
require get_template_directory() . '/inc/template-functions/slide.php';

/**
 * Custom Template Tags.
 */
require get_template_directory() . '/inc/template-tags/banner.php';
require get_template_directory() . '/inc/template-tags/employee.php';
require get_template_directory() . '/inc/template-tags/location.php';
require get_template_directory() . '/inc/template-tags/slide.php';
