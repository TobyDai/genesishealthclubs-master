...
?>
    ...
    while ( have_posts() ) :
        ...
        global $wp_query;
        $the_view = $wp_query->query_vars['template_view'];
    ?>
    ...
    <?php if ( $the_view == 'staff' ) : ?>
        ...
        <main>
            <header class="page-header">
                ...
                <h1 class="page-header__title"><?php the_title(); ?> <?php _e('Staff', 'ghc'); ?></h1>
            </header>

            <div class="page-content">
                <?php $employees = ghc_get_employees_by_location( get_the_ID() ); ?>
                <div class="employee-list">
                    <?php foreach ( $employees as $employee ) : ?>
                        <?php ghc_the_employee_list_item( $employee->ID ); ?>
