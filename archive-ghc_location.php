						...
						<a href="<?php echo get_term_link( $market, 'ghc_location_market' ); ?>" title="<?php echo $market->name; ?>">
							<div class="card-list__item__content">
								<div class="card-list__item__content__details">
									...
									<?php if ( ghc_get_market_excerpt( $market->term_id ) != '' ) : ?>
										<p><?php echo ghc_get_market_excerpt( $market->term_id ); ?></p>
									<?php else : ?>
								...
								<div class="card-list__item__content__media" style="background-image: url(<?php echo ghc_get_market_image_url( $market->term_id ); ?>);">
									<img src="<?php echo ghc_get_market_image_url( $market->term_id ); ?>" alt="">
								</div>
							</div>
						</a>
					</div>
